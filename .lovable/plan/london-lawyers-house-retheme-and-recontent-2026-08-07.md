...
- **Services** — eyebrow OUR SERVICES, supplied heading/description. Three primary cards (Cross-Border Disputes, Property Law, Criminal Defence) with numbered 01–03 labels, keeping the current card interaction and hover reveal; the three additional services (Bilingual Legal Advisory, Financial Claims & Debt Recovery, Business & Legal Disputes) appear as a numbered 04–06 text list below. CTA "View All Services".
- **Approach** — eyebrow OUR APPROACH, heading "Legal support you can rely on.", three items (Bilingual Perspective, Practical Solutions, Professional Support). The existing marquee stays.
